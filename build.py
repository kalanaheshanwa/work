...
PROJECTS = [
    ...
    },
    {
        ...
        "sub": "A high-converting single-page marketing site for a luxury 55+ condo development \u2014 built around urgency, exclusivity and tour bookings.",
        "overview": "Steeple Glenn is a boutique luxury condominium development in Newark, Delaware, offering move-in ready 2 and 3-bedroom residences designed for 55+ active adults seeking a refined, maintenance-free lifestyle. With only 9 homes remaining and a limited-time $70,000 upgrade offer, they needed a high-converting marketing website that would create urgency and drive qualified tour bookings fast.",
        "solution_p": "Designed and developed a full single-page Squarespace real estate marketing website built around urgency, exclusivity, and lifestyle aspiration. The site features a bold hero with limited availability messaging, premium upgrade highlights, three residence model showcases, amenities and interior finishes sections, an interior photography gallery, a home valuation tool, FAQ accordion, location highlights, and a multi-CTA contact flow \u2014 all engineered to move serious buyers from interest to inquiry.",
    ...
    },
    {
        ...
        "sub": "A persuasive, copy-driven Squarespace site for a brand strategy consultancy \u2014 built to turn skeptical visitors into booked calls.",
        "overview": "Brand Your Journey is a brand strategy consultancy serving nonprofits, startups, and small businesses under $2M \u2014 helping them define who they are, who they\u2019re for, and why it matters. They needed a persuasive, conversion-focused website that clearly articulated the value of brand strategy to an audience that often underestimates it.",
        "solution_p": "Designed and developed a sharp, copy-driven Squarespace website built to educate and convert. The site features a problem-aware homepage that speaks directly to the pain of inconsistent branding, a clear three-step process section, audience segmentation for nonprofits, startups, and small businesses, a blog (\u201cThe Strategy Room\u201d), client testimonials, and a free consultation CTA \u2014 all structured to take skeptical visitors from \u201cdo I really need this?\u201d to booking a call.",
    ...
    },
    {
        ...
        "cat_slugs": ["photo", "convert"],
        "cat_label": "Film & Video",
        "duration": "2 Weeks",
        "industry": "Film & Videography",
        "tech": ["Squarespace", "HTML"],
        "sub": "A sleek, cinematic personal-brand site for a Hollywood producer \u2014 built pixel-accurate from client HTML into an editable Squarespace site.",
        "overview": "Nadia Sarmova is a Hollywood-based producer, writer, and social entrepreneur known for creating impactful visual storytelling that highlights critical social issues and marginalized communities. As the founder of Beam In Studios and co-founder of The Shift, she needed a polished personal brand website that matched her industry authority and positioned her as a credible, sought-after executive in the entertainment world.",
        "solution_p": "Designed and developed a sleek, cinematic Squarespace personal portfolio website built from client-provided pre-designed HTML files and images \u2014 accurately translating a custom design vision into a fully functional Squarespace site. The site showcases Nadia\u2019s biography, film credits, production companies, and social impact work \u2014 all crafted to establish her personal brand and make a strong first impression with collaborators, studios, and press.",
    ...
    },
    {
        ...
        "tech": ["Squarespace", "Claude"],
        "sub": "A trust-building, conversion-focused Squarespace site for a Dayton Medicare agency \u2014 rebuilt from client HTML across 13 pages.",
        "overview": "Premier Medicare Planning is an independent Medicare insurance agency based in Dayton, Ohio, helping seniors navigate Medicare Advantage, Supplement, and Part D plans across 15+ carriers at no cost to the client. They needed a professional, trust-building website that would simplify a complex topic, establish local credibility, and drive free consultation bookings.",
        "solution_p": "Designed and developed a multi-page Squarespace website built from client-provided HTML files \u2014 converting and integrating custom-coded page content into a fully functional Squarespace site. The site features a conversion-focused homepage, dedicated service pages for Medicare Advantage, Supplement, Part D, and Turning 65 planning, a step-by-step enrollment guide, client testimonials, a blog, and a free consultation CTA \u2014 all structured to educate hesitant seniors and convert them into booked consultations.",
    ...
    },
    {
        ...
        "industry": "Real Estate",
        "tech": ["Squarespace"],
        "sub": "A cinematic single-page Squarespace marketing site for a 45-unit luxury condo development \u2014 built to drive private tour bookings.",
        "overview": "Coffee Run is a boutique luxury condominium development in Hockessin, Delaware \u2014 offering 45 exclusive maintenance-free residences set across 14 landscaped acres in the Brandywine Valley. With limited availability and high buyer interest, they needed a high-impact real estate marketing website that would generate qualified leads and communicate the prestige of the development before a single unit was sold.",
        "solution_p": "Designed and developed a visually rich, single-page Squarespace real estate marketing website that functions as a complete pre-sales tool. The site features cinematic hero sections, a lifestyle narrative, amenities showcase, interactive interior renderings carousel, multi-floor plan gallery, location highlights, team profiles, a real estate agent integration, and a lead capture inquiry form \u2014 all crafted to evoke exclusivity and drive private tour bookings.",
...
def topbar_index():
    return f"""<header class="topbar"><div class="wrap">
  <a class="brand" href="index.html"><span class="mark"></span><b>Kalana&nbsp;Square</b><span>&nbsp;/ Work</span></a>
  <nav><a href="#portfolio">Work</a><a href="#reviews">Reviews</a><a href="#about">About</a><a class="nav-linkedin" href="{LINKEDIN}" target="_blank" rel="noopener" aria-label="View Kalana Heshan on LinkedIn">{LINKEDIN_ICON}</a><a class="nav-hire" href="{UPWORK}" target="_blank" rel="noopener">Hire on Upwork&nbsp;\u2197</a></nav>
</div></header>"""
